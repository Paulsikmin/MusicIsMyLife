...
public class AnthologyFunction {

	List<Anthology> aList;
	
	public AnthologyFunction() {
		aList = new ArrayList<Anthology>();
		aList.add(new Anthology());
	}
	...
	public int printMenu() {
		...
		System.out.println("+============================================================+");
		System.out.println("∥                                                            ∥");
		System.out.println("∥                         시 모음집                          ∥");
		System.out.println("∥                                                            ∥");
		System.out.println("∥                                                            ∥");
		System.out.println("∥                     지친 마음을 달래줄                     ∥");
		System.out.println("∥                                                            ∥");
		System.out.println("∥                   시 추천 프로그램 입니다.                 ∥");
		System.out.println("∥                                                            ∥");
		System.out.println("∥  아래의 선택 사항을 골라주시면 알맞는 시를 추천해드릴게요. ∥");
		System.out.println("∥                                                            ∥");
		System.out.println("+============================================================+");
		System.out.println("1. 계절에 따른 시 추천");
		System.out.println("2. 날씨에 따른 시 추천");
		System.out.println("3. 나의 감정에 따른 시 추천");
		System.out.println("4. 랜덤 시 추천");
	...
	public int seasonMenu() {
		Scanner sc = new Scanner(System.in);
		System.out.println("계절에 따른 시 추천을 선택하셨습니다.");
